...
export const metadata: Metadata = {
  ...
  description: '유기폐기물을 활용한 친환경 바이오가스 생산 시스템 서비스를 소개합니다.',
};
  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-green-600 font-medium">바이오가스 생산</span>
          </div>
        </div>
      </nav>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-12 rounded-2xl">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                바이오가스 생산 서비스에 대한 상세한 내용은 고객 자료 제공 후 업데이트될 예정입니다.
              </p>
              <div className="space-y-4 text-left max-w-md mx-auto">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-gray-600">기술 소개</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-gray-600">프로세스 설명</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-gray-600">장점 및 효과</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-gray-600">적용 사례</span>
                </div>
              </div>
            </div>
          </div>
