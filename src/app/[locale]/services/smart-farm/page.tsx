...
export default function SmartFarmPage({params: {locale}}: {params: {locale: string}}) {
  return (
      ...
      <nav className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-base text-gray-700 font-semibold">
            <Link href={`/${locale}`} className="hover:text-purple-600 transition-colors">홈</Link>
            <span className="text-gray-400">/</span>
            <Link href={`/${locale}/services`} className="hover:text-purple-600 transition-colors">서비스</Link>
            <span className="text-gray-400">/</span>
