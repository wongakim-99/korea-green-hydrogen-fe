...
// Note: metadata export는 client component에서 사용할 수 없으므로 별도 파일로 분리하거나 server component로 만들어야 함
...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // 실제 구현에서는 여기서 API 호출 등을 할 수 있습니다
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">연락 정보</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">본사 주소</h3>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-green-600 text-white py-3 px-6 rounded-md font-semibold hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
                  문의하기
                </button>
              </form>
      ...
      {/* Map Section - 실제 구현에서는 Google Maps API 등을 사용할 수 있습니다 */}
          ...
          <div className="bg-gray-300 h-96 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">
                실제 구현에서는 Google Maps 또는 네이버 지도 API를 연동할 수 있습니다
              </p>
            </div>
          </div>
        </div>
