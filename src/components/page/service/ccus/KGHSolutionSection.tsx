        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 lg:col-span-6">
              <div className="relative rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-blue-50 to-cyan-50 aspect-[4/3] flex items-center justify-center">
                {/* TODO: 고객사 이미지로 교체 */}
            ...
            <div className="order-1 lg:order-2 lg:col-span-6 space-y-8 md:space-y-10">
              <div>
                ...
                <p className="text-lg sm:text-xl text-cyan-600 font-semibold mb-6">
                  {t('subtitle')}
                </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6">
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg">
                  <div className="text-2xl font-bold text-cyan-600 mb-2">{t('feature1_title')}</div>
                ...
                <div className="text-center p-4 bg-gradient-to-br from-cyan-50 to-blue-50 rounded-lg">
                  <div className="text-2xl font-bold text-cyan-600 mb-2">{t('feature2_title')}</div>
                  <div className="text-sm text-gray-600 break-keep">{t('feature2_description')}</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg">
                  <div className="text-2xl font-bold text-cyan-600 mb-2">{t('feature3_title')}</div>
