            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6 relative">
              ...
              <div className="relative">
                <div className="flex items-start space-x-4 lg:block">
                  <div className="flex-shrink-0 w-16 h-16 lg:w-20 lg:h-20 bg-gray-900 rounded-lg flex items-center justify-center lg:mx-auto mb-0 lg:mb-6 relative z-10">
                    <span className="text-2xl lg:text-3xl font-bold text-white">01</span>
                  </div>
                  <div className="flex-1 lg:text-center pt-1 lg:pt-0">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">원료 수집</h3>
              ...
              <div className="relative">
                <div className="flex items-start space-x-4 lg:block">
                  ...
                  <div className="flex-1 lg:text-center pt-1 lg:pt-0">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">THP 처리</h3>
              ...
              <div className="relative">
                <div className="flex items-start space-x-4 lg:block">
                  ...
                  <div className="flex-1 lg:text-center pt-1 lg:pt-0">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">바이오가스 생산</h3>
              ...
              <div className="relative">
                <div className="flex items-start space-x-4 lg:block">
                  ...
                  <div className="flex-1 lg:text-center pt-1 lg:pt-0">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">수소 전환</h3>
