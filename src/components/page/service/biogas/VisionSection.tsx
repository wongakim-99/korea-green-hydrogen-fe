        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-6">
                  지속가능한 미래를 위한 선택,<br />
                  <span className="text-blue-600">폐기물 처리의 패러다임을 바꾸다</span>
                </h2>
              </div>
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  ...
                  <span className="font-semibold text-blue-600"> 수소와 비료를 생산하는 혁신적이고 친환경적인 에너지 사업 모델</span>을 제시합니다.
                </p>
                <p>
                  이 비전의 중심에는 지역 내 하수 슬러지, 음식물 폐기물 등 유기성 폐기물을 통합 처리하여 
                  가치있는 자원으로 전환하는 핵심 시설, <strong className="bg-blue-50 text-blue-800 px-2 py-1 rounded">바이오가스 센터</strong>가 있습니다.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-indigo-500 rounded-full opacity-20"></div>
            </div>
          </div>
        </div>
      </div>
