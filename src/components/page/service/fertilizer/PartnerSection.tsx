...
export default function PartnerSection() {
  ...
  return (
    <section ref={ref} className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-gray-50 to-sky-50/30 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-8 md:space-y-10">
              <div>
                ...
                <p className="text-2xl md:text-3xl font-bold text-sky-600 mb-6 break-keep">
                  {t('subtitle')}
                </p>
                ...
                <div className="space-y-6 text-base sm:text-lg text-gray-700 leading-relaxed">
                  ...
                  <p className="break-keep font-semibold">{t('description3')}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 pt-4">
                <div>
                  <div className="flex items-center mb-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-gray-900 break-keep">{t('value1_title')}</h3>
                ...
                <div>
                  <div className="flex items-center mb-3">
                    <div className="w-1 h-12 bg-sky-500 mr-4"></div>
                    <div>
                      <h3 className="text-lg font-bold text-gray-900 break-keep">{t('value2_title')}</h3>
                ...
                <div>
                  <div className="flex items-center mb-3">
                    <div className="w-1 h-12 bg-sky-500 mr-4"></div>
                    <div>
                      <h3 className="text-lg font-bold text-gray-900 break-keep">{t('value3_title')}</h3>
