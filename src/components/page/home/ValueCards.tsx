    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
        ...
        <div 
          ...
          {/* 폐기물의 자원화 카드 */}
          <div 
            className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer h-80"
          ...
          >
            ...
            <div className="p-8 group-hover:p-6 transition-all duration-500 h-full flex flex-col">
              <div className="flex items-center justify-center w-20 h-20 bg-green-100 rounded-full mb-6 mx-auto group-hover:w-16 group-hover:h-16 group-hover:mb-4 transition-all duration-500 flex-shrink-0">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center group-hover:text-lg group-hover:mb-3 transition-all duration-500 flex-shrink-0">
                {t('card1_title')}
              </h3>
              <p className="text-sm text-gray-500 text-center mb-4 group-hover:mb-2 transition-all duration-500 flex-shrink-0">
                {t('card1_subtitle')}
              </p>
              
              <div className="opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:delay-200 flex-1 flex items-start">
          ...
          >
            ...
            <div className="p-8 group-hover:p-6 transition-all duration-500 h-full flex flex-col">
              <div className="flex items-center justify-center w-20 h-20 bg-blue-100 rounded-full mb-6 mx-auto group-hover:w-16 group-hover:h-16 group-hover:mb-4 transition-all duration-500 flex-shrink-0">
          ...
          >
            ...
            <div className="p-8 group-hover:p-6 transition-all duration-500 h-full flex flex-col">
              <div className="flex items-center justify-center w-20 h-20 bg-purple-100 rounded-full mb-6 mx-auto group-hover:w-16 group-hover:h-16 group-hover:mb-4 transition-all duration-500 flex-shrink-0">
